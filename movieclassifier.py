...
class Movieclassifier(object):
    ...
    def bm25_relevance(self, terms, matches, current_doc, total_docs, b, k):
        score = b
    ...
    def search(self, query, offset = 0, limit = 20):
        ...
        for doc_id, current_doc in per_doc_counts.items():
            scored_results.append({
                'id': doc_id,
                'score': self.bm25_relevance(terms, per_term_docs, current_doc, total_docs, len(current_doc), 1.2),
            })
